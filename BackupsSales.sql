...
DECLARE @Path NVARCHAR(255) = 'D:\Pessoal\Faculdade\2º Ano\1º Semestre\CBD\Projeto-CBD\scripts\Backups\AdventureWorks_SalesBAKS\' 

-- Construir os nomes dos arquivos de backup
DECLARE @FullBackup NVARCHAR(255) = @Path + @BaseDados + '_Full_Backup.bak'
DECLARE @BackupDiferencial NVARCHAR(255) = @Path + @BaseDados + '_Backup_Diferencial.bak'
DECLARE @BackupLogs NVARCHAR(255) = @Path + @BaseDados + '_Backup_Log.trn'
...
PRINT 'Backup completo da Base de dados ' + @BaseDados + ' realizado com sucesso. Caminho do backup: ' + @FullBackup;
...
BEGIN
    ...
    BACKUP DATABASE @BaseDados
    TO DISK = @BackupDiferencial
    WITH DIFFERENTIAL, INIT;

    PRINT 'Backup diferencial da Base de dados ' + @BaseDados + ' realizado com sucesso. Caminho do backup: ' + @BackupDiferencial;
END
ELSE
BEGIN
...
PRINT 'Backup de log da Base de dados ' + @BaseDados + ' realizado com sucesso. Caminho do backup: ' + @BackupLogs;
...
DECLARE @pathTail NVARCHAR(255) = 'D:\Pessoal\Faculdade\2º Ano\1º Semestre\CBD\Projeto-CBD\scripts\Backups\AdventureWorks_SalesBAKS\TailLogs' 
...
SET @LastFullBackup = 'D:\Pessoal\Faculdade\2º Ano\1º Semestre\CBD\Projeto-CBD\scripts\Backups\AdventureWorks_SalesBAKS\AdventureWorks_Full_Backup.bak'
SET @LastDifferencial = 'D:\Pessoal\Faculdade\2º Ano\1º Semestre\CBD\Projeto-CBD\scripts\Backups\AdventureWorks_SalesBAKS\AdventureWorks_Backup_Diferencial.bak'
SET @LastTransactionLog = 'D:\Pessoal\Faculdade\2º Ano\1º Semestre\CBD\Projeto-CBD\scripts\Backups\AdventureWorks_SalesBAKS\AdventureWorks_Backup_Log.trn'
